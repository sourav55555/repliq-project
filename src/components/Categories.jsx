    ...
    return (
        <div className={`fixed transition-all duration-300 w-full top-0 z-10 ${showCategory ? "right-0" : "-right-[100%]"} `}>
            <div className='flex items-start flex-row-reverse'>
                ...
                <div className='md:w-[47%] w-[90%] p-4 md:p-10 bg-white lg:h-auto min-h-screen'>
                    <p className='text-4xl mb-16 font-semibold text-center'>Categories</p>
                    <div className='flex flex-wrap gap-4'>
                        <button
                            className="px-4 border-[#176B87] secondary py-2 rounded-md border-2 text-lg"
                ...
                <div className='md:w-[53%] w-[10%] bg-[#00000063] h-screen' onClick={() => setShowCategory(false)} >
                    <X
                        onClick={() => setShowCategory(false)}
                        className='ms-auto mt-4 me-4 cursor-pointer text-white w-8 h-8'
                    />
                </div>
            </div>
        </div>
